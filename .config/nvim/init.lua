...
vim.keymap.set("x", "<Leader>p", [["_dP]], { desc = "Paste, don't yank" })
vim.keymap.set("n", "<Leader>fb", "<CMD>Explore<CR>", { desc = "Explorer" })

vim.keymap.set("n", "<leader>e", vim.diagnostic.open_float, { desc = "Diagnostic hover" })
...
require("lazy").setup({
  ...
  { "lewis6991/gitsigns.nvim" },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader><leader><leader>", builtin.resume, { desc = "[S]earch [R]esume" })
  ...
  },
  {
    ...
    dependencies = {
      ...
      { "nvim-java/nvim-java",     opts = {}, ft = { "java" } },
  ...
  },
  {
    ...
    config = function()
      ...
      for i = 1, 9, 1 do
        vim.keymap.set("n", "<leader>" .. i, function() harpoon:list():select(i) end, { desc = "Harpoon GOTO " .. i })
      end
    end,
  },
  { "mbbill/undotree" },
